...
virtual_inbox = True # bool | Virtual inbox prevents any outbound emails from being sent. It creates sent email records but will never send real emails to recipients. Great for testing and faking email sending. (optional)
    ...
    try:
        # Create an inbox email address. An inbox has a real email address and can send and receive emails. Inboxes can be either `SMTP` or `HTTP` inboxes.
        api_response = api_instance.create_inbox(email_address=email_address, tags=tags, name=name, description=description, use_domain_pool=use_domain_pool, favourite=favourite, expires_at=expires_at, expires_in=expires_in, allow_team_access=allow_team_access, inbox_type=inbox_type, virtual_inbox=virtual_inbox)
        pprint(api_response)
...
with mailslurp_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling InboxControllerApi->delete_all_inbox_emails: %s\n" % e)
```
...
with mailslurp_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = mailslurp_client.InboxControllerApi(api_client)
    page = 0 # int | Optional page index in scheduled job list pagination (optional) (default to 0)
...
before = '2013-10-20T19:20:30+01:00' # datetime | Filter by created at before the given timestamp (optional)
    ...
    try:
        ...
        print("Exception when calling InboxControllerApi->get_all_scheduled_jobs: %s\n" % e)
```
...
before = '2013-10-20T19:20:30+01:00' # datetime | Filter by created at before the given timestamp (optional)
    ...
    try:
        ...
        print("Exception when calling InboxControllerApi->get_delivery_statuses_by_inbox_id: %s\n" % e)
```
...
with mailslurp_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling InboxControllerApi->get_imap_smtp_access: %s\n" % e)
```
...
with mailslurp_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling InboxControllerApi->get_inbox_by_name: %s\n" % e)
```
...
timeout_millis = 56 # int | Timeout milliseconds to wait for latest email
    ...
    try:
        ...
        print("Exception when calling InboxControllerApi->get_latest_email_in_inbox: %s\n" % e)
```
...
before = '2013-10-20T19:20:30+01:00' # datetime | Filter by created at before the given timestamp (optional)
    ...
    try:
        ...
        print("Exception when calling InboxControllerApi->get_scheduled_jobs_by_inbox_id: %s\n" % e)
```
...
send_email_options = mailslurp_client.SendEmailOptions() # SendEmailOptions | 
    ...
    try:
        ...
        print("Exception when calling InboxControllerApi->send_email_with_queue: %s\n" % e)
```
...
send_smtp_envelope_options = mailslurp_client.SendSMTPEnvelopeOptions() # SendSMTPEnvelopeOptions | 
    ...
    try:
        ...
        print("Exception when calling InboxControllerApi->send_smtp_envelope: %s\n" % e)
```
...
# **send_with_schedule**
> send_with_schedule(inbox_id, send_email_options, send_at_timestamp=send_at_timestamp, send_at_now_plus_seconds=send_at_now_plus_seconds, validate_before_enqueue=validate_before_enqueue)
...
validate_before_enqueue = True # bool | Validate before adding to queue (optional)
    ...
    try:
        # Send email with with delay or schedule
        api_instance.send_with_schedule(inbox_id, send_email_options, send_at_timestamp=send_at_timestamp, send_at_now_plus_seconds=send_at_now_plus_seconds, validate_before_enqueue=validate_before_enqueue)
    except ApiException as e:
        print("Exception when calling InboxControllerApi->send_with_schedule: %s\n" % e)
```
