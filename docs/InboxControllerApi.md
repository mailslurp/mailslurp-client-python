...
# **does_inbox_exist**
> InboxExistsDto does_inbox_exist(email_address, allow_catch_all=allow_catch_all)
...
allow_catch_all = True # bool |  (optional)

    try:
        # Does inbox exist
        api_response = api_instance.does_inbox_exist(email_address, allow_catch_all=allow_catch_all)
        pprint(api_response)
    except ApiException as e:
