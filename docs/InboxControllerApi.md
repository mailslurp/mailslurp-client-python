...
# **create_inbox**
> Inbox create_inbox(description=description, email_address=email_address, expires_at=expires_at, favourite=favourite, name=name, tags=tags, use_domain_pool=use_domain_pool)
...
use_domain_pool = True # bool | Use the MailSlurp domain name pool with this inbox when creating the email address. Defaults to null. If enabled the inbox will be an email address with a domain randomly chosen from a list of the MailSlurp domains. This is useful when the default `@mailslurp.com` email addresses used with inboxes are blocked or considered spam by a provider or receiving service. When domain pool is enabled an email address will be generated ending in `@mailslurp.{world,info,xyz,...}` . This means a TLD is randomly selecting from a list of `.biz`, `.info`, `.xyz` etc to add variance to the generated email addresses. When null or false MailSlurp uses the default behavior of `@mailslurp.com` or custom email address provided by the emailAddress field. (optional)
    ...
    try:
        # Create an Inbox (email address)
        api_response = api_instance.create_inbox(description=description, email_address=email_address, expires_at=expires_at, favourite=favourite, name=name, tags=tags, use_domain_pool=use_domain_pool)
        pprint(api_response)
 ...
 **tags** | [**list[str]**](str.md)| Tags that inbox has been tagged with. Tags can be added to inboxes to group different inboxes within an account. You can also search for inboxes by tag in the dashboard UI. | [optional] 
...
with mailslurp_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get an expired inbox record
        api_response = api_instance.get_expired_inbox_record_by_id(expired_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling InboxControllerApi->get_expired_inbox_record_by_id: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **expired_id** | [**str**](.md)| ID of the ExpiredInboxRecord you want to retrieve. This is different from the ID of the inbox you are interested in. See other methods for getting ExpiredInboxRecord for an inbox inboxId) | 
...
with mailslurp_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get expired inbox record for a previously existing inbox
        api_response = api_instance.get_expired_inbox_record_by_inbox_id(inbox_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling InboxControllerApi->get_expired_inbox_record_by_inbox_id: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inbox_id** | [**str**](.md)| ID of inbox you want to retrieve (not the inbox ID) | 
...
> PageExpiredInboxRecordProjection get_expired_inbox_records(page=page, size=size, sort=sort)
...
sort = 'ASC' # str | Optional createdAt sort direction ASC or DESC (optional) (default to 'ASC')
    ...
    try:
        # List records of expired inboxes
        api_response = api_instance.get_expired_inbox_records(page=page, size=size, sort=sort)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling InboxControllerApi->get_expired_inbox_records: %s\n" % e)
```
