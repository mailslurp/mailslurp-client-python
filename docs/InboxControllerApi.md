 ...
 **inbox_type** | **str**| HTTP (default) or SMTP inbox type. HTTP inboxes are best for testing while SMTP inboxes are more reliable for public inbound email consumption. When using custom domains the domain type must match the inbox type. HTTP inboxes are processed by AWS SES while SMTP inboxes use a custom mail server running at &#x60;mx.mailslurp.com&#x60;. | [optional] 
...
# **get_emails**
> list[EmailPreview] get_emails(inbox_id, delay_timeout=delay_timeout, limit=limit, min_count=min_count, retry_timeout=retry_timeout, since=since, size=size, sort=sort, unread_only=unread_only)
...
unread_only = True # bool | unreadOnly (optional)
    ...
    try:
        # Get emails in an Inbox. This method is not idempotent as it allows retries and waits if you want certain conditions to be met before returning. For simple listing and sorting of known emails use the email controller instead.
        api_response = api_instance.get_emails(inbox_id, delay_timeout=delay_timeout, limit=limit, min_count=min_count, retry_timeout=retry_timeout, since=since, size=size, sort=sort, unread_only=unread_only)
        pprint(api_response)
    except ApiException as e:
...
> PageSentEmailProjection get_inbox_sent_emails(inbox_id, page=page, search_filter=search_filter, size=size, sort=sort)
...
sort = 'ASC' # str | Optional createdAt sort direction ASC or DESC (optional) (default to 'ASC')
    ...
    try:
        # Get Inbox Sent Emails
        api_response = api_instance.get_inbox_sent_emails(inbox_id, page=page, search_filter=search_filter, size=size, sort=sort)
        pprint(api_response)
    except ApiException as e:
...
sort = 'ASC' # str | Optional createdAt sort direction ASC or DESC (optional) (default to 'ASC')
    ...
    try:
        # List Organization Inboxes Paginated
        api_response = api_instance.get_organization_inboxes(page=page, search_filter=search_filter, size=size, sort=sort)
        pprint(api_response)
    except ApiException as e:
...
# **list_inbox_rulesets**
> PageInboxRulesetDto list_inbox_rulesets(inbox_id, page=page, search_filter=search_filter, size=size, sort=sort)
...
sort = 'ASC' # str | Optional createdAt sort direction ASC or DESC (optional) (default to 'ASC')
    ...
    try:
        # List inbox rulesets
        api_response = api_instance.list_inbox_rulesets(inbox_id, page=page, search_filter=search_filter, size=size, sort=sort)
        pprint(api_response)
    except ApiException as e:
...
> PageTrackingPixelProjection list_inbox_tracking_pixels(inbox_id, page=page, search_filter=search_filter, size=size, sort=sort)
...
sort = 'ASC' # str | Optional createdAt sort direction ASC or DESC (optional) (default to 'ASC')
    ...
    try:
        # List inbox tracking pixels
        api_response = api_instance.list_inbox_tracking_pixels(inbox_id, page=page, search_filter=search_filter, size=size, sort=sort)
        pprint(api_response)
    except ApiException as e:
