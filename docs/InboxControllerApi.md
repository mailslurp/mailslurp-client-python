...
# **list_inbox_rulesets**
> list_inbox_rulesets(inbox_id, page=page, search_filter=search_filter, size=size, sort=sort)
...
sort = 'ASC' # str | Optional createdAt sort direction ASC or DESC (optional) (default to 'ASC')
    ...
    try:
        # List inbox rulesets
        api_instance.list_inbox_rulesets(inbox_id, page=page, search_filter=search_filter, size=size, sort=sort)
    except ApiException as e:
