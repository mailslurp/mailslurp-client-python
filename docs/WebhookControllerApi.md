...
sort = 'ASC' # str | Optional createdAt sort direction ASC or DESC (optional) (default to 'ASC')
    ...
    try:
        # Get results for all webhooks
        api_response = api_instance.get_all_webhook_results(page=page, search_filter=search_filter, size=size, sort=sort)
        pprint(api_response)
    except ApiException as e:
...
sort = 'DESC' # str | Optional createdAt sort direction ASC or DESC (optional) (default to 'DESC')
    ...
    try:
        # List Webhooks Paginated
        api_response = api_instance.get_all_webhooks(page=page, search_filter=search_filter, size=size, sort=sort)
        pprint(api_response)
    except ApiException as e:
...
> PageWebhookProjection get_inbox_webhooks_paginated(inbox_id, page=page, search_filter=search_filter, size=size, sort=sort)
...
sort = 'ASC' # str | Optional createdAt sort direction ASC or DESC (optional) (default to 'ASC')
    ...
    try:
        # Get paginated webhooks for an Inbox
        api_response = api_instance.get_inbox_webhooks_paginated(inbox_id, page=page, search_filter=search_filter, size=size, sort=sort)
        pprint(api_response)
    except ApiException as e:
...
# **get_webhook_results**
> PageWebhookResult get_webhook_results(webhook_id, page=page, search_filter=search_filter, size=size, sort=sort)
...
sort = 'ASC' # str | Optional createdAt sort direction ASC or DESC (optional) (default to 'ASC')
    ...
    try:
        # Get a webhook results for a webhook
        api_response = api_instance.get_webhook_results(webhook_id, page=page, search_filter=search_filter, size=size, sort=sort)
        pprint(api_response)
    except ApiException as e:
