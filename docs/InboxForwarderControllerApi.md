...
with mailslurp_client.ApiClient(configuration) as api_client:
    ...
    api_instance = mailslurp_client.InboxForwarderControllerApi(api_client)
    id = 'id_example' # str | ID of inbox forwarder
page = 0 # int | Optional page index in inbox forwarder event list pagination (optional) (default to 0)
...
sort = 'ASC' # str | Optional createdAt sort direction ASC or DESC (optional) (default to 'ASC')
    ...
    try:
        ...
        print("Exception when calling InboxForwarderControllerApi->get_inbox_forwarder_events: %s\n" % e)
```
...
create_inbox_forwarder_options = mailslurp_client.CreateInboxForwarderOptions() # CreateInboxForwarderOptions | 
    ...
    try:
        ...
        print("Exception when calling InboxForwarderControllerApi->update_inbox_forwarder: %s\n" % e)
```
