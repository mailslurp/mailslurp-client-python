...
with mailslurp_client.ApiClient(configuration) as api_client:
    ...
    create_contact_options = mailslurp_client.CreateContactOptions() # CreateContactOptions | createContactOptions
...
sort = 'ASC' # str | Optional createdAt sort direction ASC or DESC (optional) (default to 'ASC')
    ...
    try:
        # Get all contacts
        api_response = api_instance.get_all_contacts(before=before, page=page, since=since, size=size, sort=sort)
        pprint(api_response)
    except ApiException as e:
...
# **get_contact_v_card**
> str get_contact_v_card(contact_id)
