...
> send_email_source_optional(inbox_id, send_email_options, use_domain_pool=use_domain_pool)
...
use_domain_pool = True # bool | Use domain pool. Optionally create inbox to send from using the mailslurp domain pool. (optional)
    ...
    try:
        # Send email
        api_instance.send_email_source_optional(inbox_id, send_email_options, use_domain_pool=use_domain_pool)
    except ApiException as e:
