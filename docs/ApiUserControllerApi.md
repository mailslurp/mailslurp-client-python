...
with mailslurp_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_smtp_password()
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling ApiUserControllerApi->get_smtp_password: %s\n" % e)
```
...
with mailslurp_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_smtp_username()
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling ApiUserControllerApi->get_smtp_username: %s\n" % e)
```
