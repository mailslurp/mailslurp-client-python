...
class FormControllerApi(object):
    ...
    def submit_form(self, **kwargs):  # noqa: E501
        ...
        :param str to: The email address that submitted form should be sent to. Either this or _toAlias must be present for a form to be successfully submitted..
        :param str to_alias: ID of an email alias to that form should be sent to. Aliases must be created before submission and can be used to hide an email address and reduce spam.
    ...
    def submit_form_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['email_address', 'redirect_to', 'spam_check', 'subject', 'success_message', 'to', 'to_alias', 'other_parameters']  # noqa: E501
        ...
        if 'to_alias' in local_var_params:
            form_params.append(('_toAlias', local_var_params['to_alias']))  # noqa: E501
