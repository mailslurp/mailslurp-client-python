...
class WaitForControllerApi(object):
    ...
    def wait_for_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['wait_for_conditions']  # noqa: E501
    ...
    def wait_for_latest_email(self, **kwargs):  # noqa: E501
        ...
        Will return either the last received email or wait for an email to arrive and return that. If you need to wait for an email for a non-empty inbox see the other receive methods such as waitForNthEmail or waitForEmailCount.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def wait_for_matching_email(self, match_options, **kwargs):  # noqa: E501
        ...
        Perform a search of emails in an inbox with the given patterns. If results match expected count then return or else retry the search until results are found or timeout is reached. Match options allow simple CONTAINS or EQUALS filtering on SUBJECT, TO, BCC, CC, and FROM. See the `MatchOptions` object for options.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
