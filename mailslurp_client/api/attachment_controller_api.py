...
class AttachmentControllerApi(object):
    ...
    def upload_attachment_bytes(self, inline_object1, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upload_attachment_bytes(inline_object1, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.upload_attachment_bytes_with_http_info(inline_object1, **kwargs)  # noqa: E501

    def upload_attachment_bytes_with_http_info(self, inline_object1, **kwargs):  # noqa: E501
        """Upload an attachment for sending using file byte stream input octet stream. Returns an array whose first element is the ID of the uploaded attachment.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upload_attachment_bytes_with_http_info(inline_object1, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('inline_object1' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `inline_object1` when calling `upload_attachment_bytes`")  # noqa: E501
