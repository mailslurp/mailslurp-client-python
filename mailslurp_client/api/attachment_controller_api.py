...
class AttachmentControllerApi(object):
    ...
    def upload_attachment(self, upload_options, **kwargs):  # noqa: E501
        """Upload an attachment for sending using base64 file encoding  # noqa: E501
    ...
    def upload_attachment_bytes(self, **kwargs):  # noqa: E501
        """Upload an attachment for sending using file byte stream input octet stream  # noqa: E501
    ...
    def upload_attachment_bytes_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if 'filename' in local_var_params:
            body_params = local_var_params['filename']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def upload_multipart_form(self, file, **kwargs):  # noqa: E501
        ...
        :param str x_filename: x-filename
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
