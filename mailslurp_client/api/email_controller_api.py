...
class EmailControllerApi(object):
    ...
    def reply_to_email1(self, email_id, reply_to_email_options, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reply_to_email1(email_id, reply_to_email_options, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.reply_to_email1_with_http_info(email_id, reply_to_email_options, **kwargs)  # noqa: E501

    def reply_to_email1_with_http_info(self, email_id, reply_to_email_options, **kwargs):  # noqa: E501
        """Reply to an email  # noqa: E501

        Send the reply to the email sender or reply-to and include same subject cc bcc etc. Reply to an email and the contents will be sent with the existing subject to the emails `to`, `cc`, and `bcc`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reply_to_email1_with_http_info(email_id, reply_to_email_options, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('email_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['email_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `email_id` when calling `reply_to_email1`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('reply_to_email_options' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `reply_to_email_options` when calling `reply_to_email1`")  # noqa: E501
