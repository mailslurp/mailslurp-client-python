...
class EmailControllerApi(object):
    ...
    def get_email_html_query_with_http_info(self, email_id, html_selector, **kwargs):  # noqa: E501
        ...
        if 'email_id' in local_var_params:
            path_params['emailId'] = local_var_params['email_id']  # noqa: E501
        if 'html_selector' in local_var_params:
            path_params['htmlSelector'] = local_var_params['html_selector']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/emails/{emailId}/html-query', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_email_text_lines(self, decode_html_entities, email_id, **kwargs):  # noqa: E501
        """Parse and return text from an email, stripping HTML and decoding encoded characters  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_email_text_lines(decode_html_entities, email_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_email_text_lines_with_http_info(decode_html_entities, email_id, **kwargs)  # noqa: E501

    def get_email_text_lines_with_http_info(self, decode_html_entities, email_id, **kwargs):  # noqa: E501
        """Parse and return text from an email, stripping HTML and decoding encoded characters  # noqa: E501

        Parse an email body and return the content as an array of strings. HTML parsing uses JSoup and UNIX line separators.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_email_text_lines_with_http_info(decode_html_entities, email_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('decode_html_entities' not in local_var_params or  # noqa: E501
                                                        local_var_params['decode_html_entities'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `decode_html_entities` when calling `get_email_text_lines`")  # noqa: E501
        # verify the required parameter 'email_id' is set
        if self.api_client.client_side_validation and ('email_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['email_id'] is None):  # noqa: E501
        ...
        path_params = {}
        if 'decode_html_entities' in local_var_params:
            path_params['decodeHtmlEntities'] = local_var_params['decode_html_entities']  # noqa: E501
        if 'email_id' in local_var_params:
            path_params['emailId'] = local_var_params['email_id']  # noqa: E501
