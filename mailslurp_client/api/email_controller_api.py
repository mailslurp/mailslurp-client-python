...
class EmailControllerApi(object):
    ...
    def download_attachment(self, attachment_id, email_id, **kwargs):  # noqa: E501
        """Get email attachment bytes  # noqa: E501

        Returns the specified attachment for a given email as a byte stream (file download). You can find attachment ids in email responses endpoint responses. The response type is application/octet-stream.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_email_with_http_info(self, email_id, **kwargs):  # noqa: E501
        ...
        all_params = ['email_id', 'decode']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
