...
class MissedEmailControllerApi(object):
    ...
    def get_missed_email(self, missed_email_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str missed_email_id: missedEmailId (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def wait_for_nth_missed_email(self, inbox_id, timeout, **kwargs):  # noqa: E501
        """Wait for Nth missed email  # noqa: E501

        Wait for 0 based index missed email  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.wait_for_nth_missed_email(inbox_id, timeout, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str inbox_id: Optional inbox ID filter (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.wait_for_nth_missed_email_with_http_info(inbox_id, timeout, **kwargs)  # noqa: E501

    def wait_for_nth_missed_email_with_http_info(self, inbox_id, timeout, **kwargs):  # noqa: E501
        """Wait for Nth missed email  # noqa: E501

        Wait for 0 based index missed email  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.wait_for_nth_missed_email_with_http_info(inbox_id, timeout, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('inbox_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `inbox_id` when calling `wait_for_nth_missed_email`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('timeout' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `timeout` when calling `wait_for_nth_missed_email`")  # noqa: E501
