...
class EmailProjection(object):
    ...
    def __init__(self, created_at=None, inbox_id=None, attachments=None, to=None, domain_id=None, bcc=None, cc=None, read=None, body_excerpt=None, team_access=None, body_md5_hash=None, text_excerpt=None, subject=None, id=None, _from=None, local_vars_configuration=None):  # noqa: E501
