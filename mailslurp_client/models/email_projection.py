...
class EmailProjection(object):
    ...
    def __init__(self, id=None, _from=None, team_access=None, read=None, body_md5_hash=None, body_excerpt=None, subject=None, inbox_id=None, to=None, attachments=None, bcc=None, cc=None, created_at=None, local_vars_configuration=None):  # noqa: E501
