...
class EmailProjection(object):
    ...
    def __init__(self, id=None, _from=None, subject=None, attachments=None, inbox_id=None, created_at=None, to=None, domain_id=None, bcc=None, cc=None, read=None, body_excerpt=None, team_access=None, body_md5_hash=None, local_vars_configuration=None):  # noqa: E501
