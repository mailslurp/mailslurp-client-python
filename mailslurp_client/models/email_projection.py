...
class EmailProjection(object):
    ...
    def __init__(self, attachments=None, bcc=None, body_md5_hash=None, cc=None, created_at=None, _from=None, id=None, inbox_id=None, read=None, subject=None, team_access=None, to=None, local_vars_configuration=None):  # noqa: E501
