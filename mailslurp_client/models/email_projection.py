...
class EmailProjection(object):
    ...
    def __init__(self, id=None, _from=None, subject=None, inbox_id=None, attachments=None, to=None, created_at=None, bcc=None, cc=None, domain_id=None, read=None, team_access=None, body_md5_hash=None, body_excerpt=None, local_vars_configuration=None):  # noqa: E501
