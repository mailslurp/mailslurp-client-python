...
class EmailProjection(object):
    ...
    def __init__(self, id=None, _from=None, subject=None, attachments=None, inbox_id=None, to=None, bcc=None, cc=None, created_at=None, team_access=None, read=None, body_md5_hash=None, body_excerpt=None, local_vars_configuration=None):  # noqa: E501
