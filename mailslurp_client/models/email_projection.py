...
class EmailProjection(object):
    ...
    def __init__(self, id=None, _from=None, subject=None, inbox_id=None, created_at=None, attachments=None, to=None, bcc=None, cc=None, domain_id=None, body_md5_hash=None, read=None, body_excerpt=None, team_access=None, local_vars_configuration=None):  # noqa: E501
