...
class EmailProjection(object):
    ...
    def __init__(self, id=None, _from=None, subject=None, attachments=None, inbox_id=None, to=None, created_at=None, bcc=None, cc=None, domain_id=None, body_md5_hash=None, body_excerpt=None, read=None, team_access=None, local_vars_configuration=None):  # noqa: E501
