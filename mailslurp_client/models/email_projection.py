...
class EmailProjection(object):
    ...
    def __init__(self, id=None, _from=None, subject=None, created_at=None, inbox_id=None, attachments=None, to=None, bcc=None, cc=None, team_access=None, read=None, body_md5_hash=None, body_excerpt=None, local_vars_configuration=None):  # noqa: E501
