...
class InboxReplierEventProjection(object):
    ...
    def __init__(self, replier_id=None, recipients=None, email_id=None, inbox_id=None, user_id=None, sent_id=None, created_at=None, message=None, id=None, status=None, local_vars_configuration=None):  # noqa: E501
