...
class InboxReplierEventProjection(object):
    ...
    def __init__(self, created_at=None, recipients=None, email_id=None, inbox_id=None, user_id=None, sent_id=None, replier_id=None, message=None, id=None, status=None, local_vars_configuration=None):  # noqa: E501
