...
class InboxReplierEventProjection(object):
    ...
    def __init__(self, message=None, id=None, status=None, email_id=None, inbox_id=None, user_id=None, recipients=None, created_at=None, sent_id=None, replier_id=None, local_vars_configuration=None):  # noqa: E501
