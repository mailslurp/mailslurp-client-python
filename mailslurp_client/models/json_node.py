...
class JsonNode(object):
    ...
    def __init__(self, array=None, big_decimal=None, big_integer=None, binary=None, boolean=None, container_node=None, double=None, empty=None, float=None, floating_point_number=None, int=None, integral_number=None, long=None, missing_node=None, node_type=None, null=None, number=None, object=None, pojo=None, short=None, textual=None, value_node=None, local_vars_configuration=None):  # noqa: E501
