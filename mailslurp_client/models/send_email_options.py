...
class SendEmailOptions(object):
    ...
    def __init__(self, attachments=None, bcc=None, body=None, cc=None, charset=None, _from=None, is_html=None, reply_to=None, subject=None, template=None, template_variables=None, to=None, to_contacts=None, to_group=None, local_vars_configuration=None):  # noqa: E501
    ...
    def body(self):
        ...
        Contents of email. If body contains HTML then set `isHTML` to true. You can use moustache template syntax in the body in conjunction with `toGroup` contact variables or `templateVariables` data.  # noqa: E501
    ...
    def is_html(self):
        ...
        Optional HTML flag. If true the `content-type` of the email will be `text/html`  # noqa: E501
    ...
    def template(self):
        ...
        Optional template ID to use for body. Will override body if provided  # noqa: E501
    ...
    def template_variables(self):
        ...
        Optional map of template variables. Will replace moustache syntax variables in subject and body or template with the associated values  # noqa: E501
    ...
    def to(self):
        ...
        List of destination email addresses. Even single recipients must be in array form. Max 100 recipients.  # noqa: E501
    ...
    def to_contacts(self):
        ...
        Optional list of contact IDs to send email to  # noqa: E501
    ...
    def to_group(self):
        ...
        Optional contact group ID to send email to  # noqa: E501
