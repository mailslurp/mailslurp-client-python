...
class AliasDto(object):
    ...
    def __init__(self, created_at=None, email_address=None, id=None, inbox_id=None, is_verified=None, name=None, updated_at=None, use_threads=None, user_id=None, local_vars_configuration=None):  # noqa: E501
