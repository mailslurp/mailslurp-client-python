...
class InboxPreview(object):
    ...
    def __init__(self, created_at=None, email_address=None, expires_at=None, favourite=None, id=None, inbox_type=None, name=None, tags=None, team_access=None, local_vars_configuration=None):  # noqa: E501
