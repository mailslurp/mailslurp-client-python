...
class ThreadProjection(object):
    ...
    def __init__(self, name=None, id=None, subject=None, inbox_id=None, user_id=None, created_at=None, updated_at=None, to=None, bcc=None, cc=None, alias_id=None, local_vars_configuration=None):  # noqa: E501
