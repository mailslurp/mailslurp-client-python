...
class ThreadProjection(object):
    ...
    def __init__(self, user_id=None, inbox_id=None, to=None, bcc=None, cc=None, alias_id=None, created_at=None, updated_at=None, subject=None, name=None, id=None, local_vars_configuration=None):  # noqa: E501
