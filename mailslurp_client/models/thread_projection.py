...
class ThreadProjection(object):
    ...
    def __init__(self, name=None, id=None, subject=None, user_id=None, inbox_id=None, created_at=None, to=None, bcc=None, cc=None, updated_at=None, alias_id=None, local_vars_configuration=None):  # noqa: E501
