...
class PageBouncedRecipients(object):
    ...
    def __init__(self, content=None, pageable=None, last=None, total_pages=None, total_elements=None, size=None, number=None, sort=None, first=None, number_of_elements=None, empty=None, local_vars_configuration=None):  # noqa: E501
