...
class PageBouncedRecipients(object):
    ...
    def __init__(self, content=None, pageable=None, total_elements=None, total_pages=None, last=None, size=None, number=None, sort=None, number_of_elements=None, first=None, empty=None, local_vars_configuration=None):  # noqa: E501
