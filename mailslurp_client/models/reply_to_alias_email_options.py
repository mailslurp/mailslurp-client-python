...
class ReplyToAliasEmailOptions(object):
    ...
    def __init__(self, attachments=None, body=None, charset=None, is_html=None, send_strategy=None, template=None, template_variables=None, use_inbox_name=None, local_vars_configuration=None):  # noqa: E501
