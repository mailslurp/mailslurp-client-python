...
class ReplyToAliasEmailOptions(object):
    ...
    def __init__(self, body=None, charset=None, attachments=None, template_variables=None, template=None, send_strategy=None, use_inbox_name=None, html=None, local_vars_configuration=None):  # noqa: E501
