...
class Email(object):
    ...
    def __init__(self, analysis=None, attachments=None, bcc=None, body=None, cc=None, charset=None, created_at=None, _from=None, headers=None, id=None, inbox_id=None, is_html=None, raw_url=None, read=None, subject=None, to=None, updated_at=None, user_id=None, local_vars_configuration=None):  # noqa: E501
