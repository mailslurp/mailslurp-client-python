...
class Email(object):
    ...
    def __init__(self, analysis=None, attachments=None, bcc=None, body=None, body_excerpt=None, body_md5_hash=None, cc=None, charset=None, created_at=None, _from=None, headers=None, id=None, inbox_id=None, is_html=None, read=None, recipients=None, reply_to=None, sender=None, subject=None, team_access=None, to=None, updated_at=None, user_id=None, local_vars_configuration=None):  # noqa: E501
