...
class WebhookDto(object):
    ...
    def __init__(self, basic_auth=None, created_at=None, event_name=None, id=None, inbox_id=None, method=None, name=None, payload_json_schema=None, updated_at=None, url=None, user_id=None, local_vars_configuration=None):  # noqa: E501
