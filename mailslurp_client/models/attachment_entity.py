...
class AttachmentEntity(object):
    ...
    def __init__(self, id=None, attachment_id=None, user_id=None, content_type=None, content_length=None, name=None, created_at=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
