...
class ReplyToEmailOptions(object):
    ...
    def __init__(self, attachments=None, body=None, charset=None, is_html=None, reply_to=None, send_strategy=None, template=None, template_variables=None, local_vars_configuration=None):  # noqa: E501
