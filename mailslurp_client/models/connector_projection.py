...
class ConnectorProjection(object):
    ...
    def __init__(self, id=None, inbox_id=None, user_id=None, created_at=None, sync_enabled=None, connector_type=None, sync_schedule_type=None, sync_interval=None, local_vars_configuration=None):  # noqa: E501
