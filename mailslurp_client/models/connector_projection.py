...
class ConnectorProjection(object):
    ...
    def __init__(self, enabled=None, inbox_id=None, email_address=None, user_id=None, sync_enabled=None, sync_schedule_type=None, sync_interval=None, created_at=None, name=None, id=None, local_vars_configuration=None):  # noqa: E501
