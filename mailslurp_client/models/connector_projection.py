...
class ConnectorProjection(object):
    ...
    def __init__(self, created_at=None, inbox_id=None, user_id=None, sync_enabled=None, connector_type=None, sync_schedule_type=None, sync_interval=None, id=None, local_vars_configuration=None):  # noqa: E501
