...
class WaitForConditions(object):
    ...
    def __init__(self, count=None, count_type=None, inbox_id=None, matches=None, since=None, sort_direction=None, timeout=None, unread_only=None, local_vars_configuration=None):  # noqa: E501
