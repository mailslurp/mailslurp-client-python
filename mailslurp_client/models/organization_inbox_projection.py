...
class OrganizationInboxProjection(object):
    ...
    def __init__(self, id=None, created_at=None, name=None, email_address=None, favourite=None, tags=None, team_access=None, inbox_type=None, read_only=None, virtual_inbox=None, local_vars_configuration=None):  # noqa: E501
