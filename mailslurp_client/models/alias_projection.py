...
class AliasProjection(object):
    ...
    def __init__(self, created_at=None, updated_at=None, email_address=None, user_id=None, inbox_id=None, use_threads=None, name=None, id=None, local_vars_configuration=None):  # noqa: E501
