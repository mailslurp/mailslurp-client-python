...
class AliasProjection(object):
    ...
    def __init__(self, name=None, id=None, user_id=None, email_address=None, inbox_id=None, created_at=None, updated_at=None, use_threads=None, local_vars_configuration=None):  # noqa: E501
