...
class AliasProjection(object):
    ...
    def __init__(self, email_address=None, user_id=None, inbox_id=None, use_threads=None, created_at=None, updated_at=None, name=None, id=None, local_vars_configuration=None):  # noqa: E501
