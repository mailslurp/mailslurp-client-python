...
class BounceRecipientProjection(object):
    ...
    def __init__(self, sent_email_id=None, recipient=None, bounce_type=None, action=None, created_at=None, id=None, status=None, local_vars_configuration=None):  # noqa: E501
