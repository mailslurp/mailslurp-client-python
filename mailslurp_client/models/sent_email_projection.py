...
class SentEmailProjection(object):
    ...
    def __init__(self, id=None, _from=None, user_id=None, subject=None, body_md5_hash=None, bcc=None, cc=None, inbox_id=None, attachments=None, to=None, created_at=None, local_vars_configuration=None):  # noqa: E501
