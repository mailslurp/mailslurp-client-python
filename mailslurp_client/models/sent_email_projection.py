...
class SentEmailProjection(object):
    ...
    def __init__(self, id=None, _from=None, user_id=None, subject=None, inbox_id=None, body_md5_hash=None, bcc=None, cc=None, virtual_send=None, attachments=None, created_at=None, to=None, local_vars_configuration=None):  # noqa: E501
