...
class SentEmailProjection(object):
    ...
    def __init__(self, id=None, user_id=None, body_md5_hash=None, _from=None, subject=None, attachments=None, inbox_id=None, to=None, bcc=None, cc=None, created_at=None, virtual_send=None, local_vars_configuration=None):  # noqa: E501
