...
class SentEmailProjection(object):
    ...
    def __init__(self, id=None, _from=None, subject=None, attachments=None, user_id=None, inbox_id=None, to=None, bcc=None, cc=None, created_at=None, body_md5_hash=None, virtual_send=None, local_vars_configuration=None):  # noqa: E501
