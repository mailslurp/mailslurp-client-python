...
class SentEmailProjection(object):
    ...
    def __init__(self, attachments=None, bcc=None, body_md5_hash=None, cc=None, created_at=None, _from=None, id=None, inbox_id=None, subject=None, to=None, user_id=None, local_vars_configuration=None):  # noqa: E501
