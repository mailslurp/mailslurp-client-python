...
class SentEmailProjection(object):
    ...
    def __init__(self, created_at=None, id=None, body_md5_hash=None, user_id=None, _from=None, subject=None, inbox_id=None, attachments=None, to=None, bcc=None, cc=None, virtual_send=None, local_vars_configuration=None):  # noqa: E501
