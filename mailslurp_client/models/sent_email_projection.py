...
class SentEmailProjection(object):
    ...
    def __init__(self, id=None, _from=None, user_id=None, subject=None, inbox_id=None, attachments=None, to=None, created_at=None, bcc=None, cc=None, body_md5_hash=None, virtual_send=None, local_vars_configuration=None):  # noqa: E501
