...
class WebhookEmailOpenedPayload(object):
    ...
    def __init__(self, created_at=None, event_name=None, inbox_id=None, message_id=None, pixel_id=None, recipient=None, sent_email_id=None, webhook_id=None, webhook_name=None, local_vars_configuration=None):  # noqa: E501
