...
class WebhookProjection(object):
    ...
    def __init__(self, name=None, id=None, url=None, inbox_id=None, created_at=None, updated_at=None, event_name=None, phone_number_id=None, local_vars_configuration=None):  # noqa: E501
