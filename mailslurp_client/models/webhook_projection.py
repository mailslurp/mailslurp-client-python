...
class WebhookProjection(object):
    ...
    def __init__(self, name=None, id=None, url=None, inbox_id=None, event_name=None, created_at=None, phone_number_id=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
