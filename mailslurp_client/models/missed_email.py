...
class MissedEmail(object):
    ...
    def __init__(self, attachment_count=None, bcc=None, body_excerpt=None, cc=None, created_at=None, id=None, inbox_ids=None, subject=None, to=None, updated_at=None, user_id=None, local_vars_configuration=None):  # noqa: E501
