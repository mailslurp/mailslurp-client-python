...
class AttachmentProjection(object):
    ...
    def __init__(self, name=None, content_length=None, content_type=None, created_at=None, user_id=None, attachment_id=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
