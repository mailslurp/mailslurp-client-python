...
class AttachmentProjection(object):
    ...
    def __init__(self, name=None, content_length=None, updated_at=None, user_id=None, attachment_id=None, created_at=None, content_type=None, local_vars_configuration=None):  # noqa: E501
