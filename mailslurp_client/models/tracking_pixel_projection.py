...
class TrackingPixelProjection(object):
    ...
    def __init__(self, name=None, id=None, user_id=None, inbox_id=None, seen=None, created_at=None, recipient=None, seen_at=None, sent_email_id=None, local_vars_configuration=None):  # noqa: E501
