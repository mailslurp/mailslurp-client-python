...
class TrackingPixelProjection(object):
    ...
    def __init__(self, name=None, id=None, inbox_id=None, user_id=None, sent_email_id=None, created_at=None, seen=None, recipient=None, seen_at=None, local_vars_configuration=None):  # noqa: E501
