...
class TrackingPixelProjection(object):
    ...
    def __init__(self, created_at=None, id=None, inbox_id=None, name=None, recipient=None, seen=None, seen_at=None, user_id=None, local_vars_configuration=None):  # noqa: E501
