...
class TrackingPixelProjection(object):
    ...
    def __init__(self, created_at=None, sent_email_id=None, user_id=None, inbox_id=None, recipient=None, seen=None, seen_at=None, name=None, id=None, local_vars_configuration=None):  # noqa: E501
