...
class TrackingPixelProjection(object):
    ...
    def __init__(self, name=None, id=None, created_at=None, user_id=None, inbox_id=None, recipient=None, seen=None, seen_at=None, sent_email_id=None, local_vars_configuration=None):  # noqa: E501
