...
class CreateWebhookOptions(object):
    ...
    def __init__(self, url=None, basic_auth=None, name=None, event_name=None, include_headers=None, request_body_template=None, local_vars_configuration=None):  # noqa: E501
