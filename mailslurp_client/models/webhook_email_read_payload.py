...
class WebhookEmailReadPayload(object):
    ...
    def __init__(self, created_at=None, email_id=None, email_is_read=None, event_name=None, inbox_id=None, message_id=None, webhook_id=None, webhook_name=None, local_vars_configuration=None):  # noqa: E501
