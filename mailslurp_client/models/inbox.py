...
class Inbox(object):
    ...
    def __init__(self, created_at=None, description=None, email_address=None, expires_at=None, favourite=None, id=None, name=None, read_only=None, tags=None, team_access=None, user_id=None, local_vars_configuration=None):  # noqa: E501
