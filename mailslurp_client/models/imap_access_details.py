...
class ImapAccessDetails(object):
    ...
    def __init__(self, imap_server_host=None, imap_server_port=None, imap_username=None, imap_password=None, imap_mailbox=None, local_vars_configuration=None):  # noqa: E501
