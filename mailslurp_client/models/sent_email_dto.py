...
class SentEmailDto(object):
    ...
    def __init__(self, attachments=None, bcc=None, body=None, body_md5_hash=None, cc=None, charset=None, _from=None, id=None, inbox_id=None, is_html=None, pixel_ids=None, reply_to=None, sent_at=None, subject=None, to=None, user_id=None, local_vars_configuration=None):  # noqa: E501
