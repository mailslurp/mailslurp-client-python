...
class BouncedEmailDto(object):
    ...
    def __init__(self, id=None, user_id=None, notification_type=None, sent_to_recipients=None, sender=None, bounce_mta=None, bounce_type=None, bounce_recipients=None, bounce_sub_type=None, created_at=None, local_vars_configuration=None):  # noqa: E501
