...
class EmailThreadProjection(object):
    ...
    def __init__(self, sender=None, recipients=None, user_id=None, inbox_id=None, updated_at=None, created_at=None, to=None, cc=None, bcc=None, has_attachments=None, message_count=None, last_body_excerpt=None, last_text_excerpt=None, last_created_at=None, last_from=None, last_sender=None, unread=None, subject=None, id=None, _from=None, local_vars_configuration=None):  # noqa: E501
