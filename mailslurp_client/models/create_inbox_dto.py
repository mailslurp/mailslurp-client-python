...
class CreateInboxDto(object):
    ...
    def __init__(self, email_address=None, name=None, description=None, use_domain_pool=None, tags=None, expires_at=None, favourite=None, expires_in=None, allow_team_access=None, inbox_type=None, local_vars_configuration=None):  # noqa: E501
