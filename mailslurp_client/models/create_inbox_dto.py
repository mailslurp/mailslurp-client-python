...
class CreateInboxDto(object):
    ...
    def __init__(self, description=None, email_address=None, expires_at=None, favourite=None, name=None, tags=None, use_domain_pool=None, local_vars_configuration=None):  # noqa: E501
