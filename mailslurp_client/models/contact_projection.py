...
class ContactProjection(object):
    ...
    def __init__(self, id=None, created_at=None, group_id=None, first_name=None, last_name=None, company=None, email_addresses=None, opt_out=None, local_vars_configuration=None):  # noqa: E501
