...
class ContactProjection(object):
    ...
    def __init__(self, id=None, group_id=None, created_at=None, email_addresses=None, opt_out=None, first_name=None, last_name=None, company=None, local_vars_configuration=None):  # noqa: E501
