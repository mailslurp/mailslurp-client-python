...
class ContactProjection(object):
    ...
    def __init__(self, id=None, group_id=None, email_address=None, created_at=None, first_name=None, last_name=None, company=None, email_addresses=None, opt_out=None, local_vars_configuration=None):  # noqa: E501
