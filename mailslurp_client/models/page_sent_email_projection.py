...
class PageSentEmailProjection(object):
    ...
    def __init__(self, content=None, pageable=None, total=None, size=None, number=None, number_of_elements=None, total_elements=None, total_pages=None, last=None, sort=None, first=None, empty=None, local_vars_configuration=None):  # noqa: E501
