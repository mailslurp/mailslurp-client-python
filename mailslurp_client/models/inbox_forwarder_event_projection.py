...
class InboxForwarderEventProjection(object):
    ...
    def __init__(self, created_at=None, user_id=None, email_id=None, inbox_id=None, forwarder_id=None, message=None, id=None, status=None, local_vars_configuration=None):  # noqa: E501
