...
class DomainDto(object):
    ...
    def __init__(self, catch_all_inbox_id=None, created_at=None, dkim_tokens=None, domain=None, domain_name_records=None, domain_type=None, id=None, is_verified=None, updated_at=None, user_id=None, verification_token=None, local_vars_configuration=None):  # noqa: E501
    ...
    def domain_type(self):
        ...
        The type of domain. SMTP or HTTP domains differ in what inboxes can be used with them.  # noqa: E501
