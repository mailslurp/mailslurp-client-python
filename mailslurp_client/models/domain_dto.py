...
class DomainDto(object):
    ...
    def __init__(self, catch_all_inbox_id=None, created_at=None, dkim_tokens=None, domain=None, domain_name_records=None, id=None, is_verified=None, updated_at=None, user_id=None, verification_token=None, local_vars_configuration=None):  # noqa: E501
