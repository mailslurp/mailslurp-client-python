...
class PhoneMessageThreadItemProjection(object):
    ...
    def __init__(self, body=None, phone_number_id=None, created=None, to_phone_number=None, message_direction=None, from_phone_number=None, local_vars_configuration=None):  # noqa: E501
