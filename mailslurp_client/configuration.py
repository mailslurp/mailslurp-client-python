...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of mailslurp_client.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the mailslurp_client.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = mailslurp_client.Configuration(
        signing_info = mailslurp_client.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="https://api.mailslurp.com",
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "Version of the API: beb7302db3b2458f4bba957b81a42c95e2289b11\n"\
               "SDK Package Version: 7.0.10".\
