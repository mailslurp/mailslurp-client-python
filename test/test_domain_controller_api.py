...
class TestDomainControllerApi(unittest.TestCase):
    ...
    def test_get_available_domains(self):
        """Test case for get_available_domains
    ...
    def test_get_domain_issues(self):
        """Test case for get_domain_issues

        Get domain issues  # noqa: E501
        """
        pass

    def test_get_domain_wildcard_catch_all_inbox(self):
        """Test case for get_domain_wildcard_catch_all_inbox
    ...
    def test_get_mail_slurp_domains(self):
        """Test case for get_mail_slurp_domains
